...
#set(BOOST_PACKAGE_MINOR_VERSION 57)
set(BOOST_PACKAGE_MINOR_VERSION 58)
set(BOOST_PACKAGE_VERSION 1.${BOOST_PACKAGE_MINOR_VERSION}.0)
#set(BOOST_REPO_URL http://svn.boost.org/svn/boost/tags/release/Boost_1_${BOOST_PACKAGE_MINOR_VERSION}_0)
#set(BOOST_REPO_TYPE SVN)
#set(BOOST_REPO_URL https://github.com/boostorg/boost.git)
#set(BOOST_REPO_TYPE GIT)
#set(BOOST_REPO_TAG boost-${BOOST_PACKAGE_VERSION})
#set(BOOST_REPO_URL http://downloads.sourceforge.net/project/boost/boost/${BOOST_PACKAGE_VERSION}/boost_1_${BOOST_PACKAGE_MINOR_VERSION}_0.tar.bz2)
set(BOOST_REPO_URL http://sourceforge.net/projects/boost/files/boost/${BOOST_PACKAGE_VERSION}/boost_1_${BOOST_PACKAGE_MINOR_VERSION}_0.tar.bz2/download)
set(BOOST_REPO_TYPE FILE)
#set(BOOST_URL_MD5 1be49befbdd9a5ce9def2983ba3e7b76)
set(BOOST_URL_MD5 b8839650e61e9c1c0a89f371dd475546)
set(BOOST_SOURCE "${CMAKE_BINARY_DIR}/src/Boost")
...
if(MSVC)
  ...
  elseif("$ENV{CC}}" MATCHES "xlc")
    ...
    #set(BTWO ${BTWO} toolset=gcc --build-type=complete)
    set(BTWO ${BTWO} toolset=gcc variant=debug,release --layout=tagged)
